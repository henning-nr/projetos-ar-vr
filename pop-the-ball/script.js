...
function resetGame() {
  ...
  imageLight.setAttribute(
    "material",
    "src: img/luz_lua.png; transparent: true; opacity: 0.5;"
  );

  // A luz da lua volta ser amarela
  lua.setAttribute(
    "light",
    "type: point; intensity: 5; distance: 15; decay: 3; color: #f0bb4d"
  );
...
function endGame() {
  ...
  imageLight.setAttribute(
    "material",
    "src: img/luz_end.png; transparent: true; opacity: 0.5;"
  );

  // Muda a cor da luz da lua que a lua emana
  lua.setAttribute(
    "light",
    "type: point; intensity: 10; distance: 20; decay: 3; color: #DB5166"
  );
