...
const cardsDefinitions = [
  {
    ...
    title: "Html",
    definition:
      "HTML e uma linguagem de marcaçao utilizada na construcao de paginas na Web. Documentos HTML podem ser interpretados por navegadores.",
  },
  {
    src: "img/card-python.png",
    title: "Python",
    definition:
      "Python e uma linguagem de programacao de alto nivel, interpretada de script, imperativa, orientada a objetos, funcional, de tipagem dinamica e forte. Foi lancada por Guido van Rossum em 1991.",
  },
  {
    src: "img/card-npm.png",
    title: "Npm",
    definition:
      "npm e um gerenciador de pacotes para o Node.JS npm, Inc. e uma subsidiaria do GitHub, que fornece hospedagem para desenvolvimento de software e controle de versao com o uso do Git.",
  },
  {
    src: "img/card-sql.png",
    title: "MySQL",
    definition:
      "O MySQL e um sistema de gerenciamento de banco de dados, que utiliza a linguagem SQL como interface. E atualmente um dos sistemas de gerenciamento de bancos de dados mais populares da Oracle Corporation, com mais de 10 milhoes de instalacoes pelo mundo.",
  },
  {
    src: "img/card-react.png",
    title: "React",
    definition:
      "O React e uma biblioteca front-end JavaScript de codigo aberto com foco em criar interfaces de usuario em paginas web.",
  },
  {
    src: "img/card-java.png",
    title: "Java",
    definition:
      "Java e uma linguagem de programacao orientada a objetos desenvolvida na decada de 90 por uma equipe de programadores chefiada por James Gosling, na empresa Sun Microsystems, que em 2008 foi adquirido pela empresa Oracle Corporation.",
  },
  {
    src: "img/card-js.png",
    title: "JavaScript",
    definition:
      "JavaScript e uma linguagem de programacao interpretada estruturada, de script em alto nível com tipagem dinamica fraca e multiparadigma. Juntamente com HTML e CSS, o JavaScript e uma das tres principais tecnologias da World Wide Web.",
  },
  {
    src: "img/card-angular.png",
    title: "Angular",
    definition:
      "Angular e uma plataforma de aplicacoes web de codigo-fonte aberto e front-end baseado em TypeScript liderado pela Equipe Angular do Google e por uma comunidade de individuos e corporacoes. Angular e uma reescrita completa do AngularJS, feito pela mesma equipe que o construiu.",
  },
  {
    src: "img/card-css.png",
    title: "Css",
    definition:
      "Cascading Style Sheets e um mecanismo para adicionar estilos a uma pagina web, aplicado diretamente nas tags HTML ou ficar contido dentro das tags <style>. Tambem e possivel, adicionar estilos adicionando um link para um arquivo CSS que contem os estilos.",
  },
  {
    src: "img/card-kotlin.png",
    title: "Kotlin",
    definition:
      "Kotlin é uma linguagem de programação multiplataforma, orientada a objetos e funcional, concisa e estaticamente tipada, desenvolvida em 2011 pela empresa tcheca JetBrains, que compila para a Máquina virtual Java e também traduzida para a linguagem JavaScript e compilada para código nativo.",
  },
];
...
function calculateScore(hits, errors, tempoUsado, tempoMaximo = 80) {
  let tempoRestante = Math.max(tempoMaximo - tempoUsado, 0); // Garante que não fique negativo

  let score = hits * 10 + tempoRestante * 2 - errors * 5;
...
function looseGame() {
  ...
  let score = calculateScore(hits, errors, tempo);
...
function showScore() {
  ...
  acertos.setAttribute(
    "font",
    "https://raw.githubusercontent.com/etiennepinchon/aframe-fonts/master/fonts/roboto/Roboto-Medium.json"
  );
